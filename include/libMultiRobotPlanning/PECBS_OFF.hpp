...
/*! \brief
Probability based Enhanced Conflict-Based-Search (PCBS) to solve the heterogeneous\n
multi-Robot path planning based on probabilistic motion model within a given suboptimality bound.
Details of the algorithm can be found in the following paper:\n
Biao Hu, Haonan Wang, Zhengcai Cao:\n
"Heterogeneous multi-Robot path planning based on probabilistic motion model".\n
2020 IEEE SMC. 1323-1328(2015).https://doi.org/10.1109/SMC42975.2020.9283286
